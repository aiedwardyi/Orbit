    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Alerts arrive while Orbit Mobile is open or was recently in the background. Closed-app delivery is not available yet.")
            }
...
struct ConnectionSecurityView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("This removes the connection from this iPhone only. It does not revoke this phone on your Mac. To remove Mac-side access, open Orbit → Settings → Phone and remove this device.")
        }
    }
    ...
    private var troubleshootingText: String {
        ...
        case .connecting:
            return "Orbit Mobile is trying the saved connection automatically."
