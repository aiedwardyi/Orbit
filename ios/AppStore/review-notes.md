...
Orbit Mobile is a companion for the Orbit desktop application. The
...
1. Install and start Orbit on a Mac, Windows, or Linux computer.
...
specific computer and receives no universal Orbit account credential.
The reviewer may use any email inbox they control. This optional path uses an
hosted Cloudflare Tunnel and does not require Tailscale.
