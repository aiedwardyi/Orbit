  ...
  return (
    <div>
      <div className="mb-1.5 flex items-center gap-2 text-[13px] text-ink-secondary">
        ...
        <span>{t("connections.transcription.label")}</span>
      ...
      <p className="mb-2 text-[12px] leading-relaxed text-ink-secondary">
        {t("connections.transcription.help")}
      </p>
      <div className="flex gap-2">
        <input
          ...
          placeholder={configured ? t("connections.pasteToReplace") : t("connections.transcription.placeholder")}
          aria-label={t("connections.transcription.aria")}
          autoComplete="off"
          disabled={!bridge}
      ...
      >
        {t("connections.transcription.link")} <ExternalLink size={12} />
      </a>
      {!bridge && <div className="mt-1 text-[12px] text-warning">{t("connections.desktopOnly")}</div>}
