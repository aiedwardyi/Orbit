...
// hides successful tool activity unless Show tool calls is on, so dating
// against the previous ITEM can drop the divider off the next visible line.
